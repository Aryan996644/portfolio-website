...
import AftabPhoto from '../assets/WhatsApp Image 2026-02-06 at 8.20.01 PM.jpeg';
      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <div className="text-3xl sm:text-4xl font-bold leading-tight min-h-[100px]">
            <Typewriter
              options={{
                strings: [
                  'Hi, I’m <span class="text-indigo-500">Md Kamar Rza Khan</span>',
        ...
        <div className="grid md:grid-cols-2 gap-8 items-center">
          ...
          >
            <div className="space-y-4 text-sm sm:text-base leading-relaxed">
              <p>
                Hello! I'm <strong>Md kamar Rza Khan</strong>, a passionate full stack developer based in Koderma, Jharkhand. Currently pursuing a B.Tech in CSE from Lovely Professional University, I strive to blend creativity with code.
              </p>
              <p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-6 text-sm sm:text-base">
              <p><strong>Name:</strong> Md Kamar Rza Khan</p>
              <p><strong>Email:</strong> Kamarkhan011@gmail.com</p>
        ...
        <div className="mt-16 space-y-6 text-left">
          ...
          <ul className="space-y-3 border-l border-indigo-400 pl-4">
            ...
            <li><span className="text-indigo-300 font-medium">2024</span> – Internship at GeeksforGeeks</li>
            <li><span className="text-indigo-300 font-medium">2023</span> – Started B.Tech at LPU</li>
